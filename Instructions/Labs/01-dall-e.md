...
1. To download and view the images that were generated by your app, in the toolbar for the cloud shell pane, use the **Upload/Download files** button to download a file, and then open it. To download a file, complete it's file path in the download interface; for example:
